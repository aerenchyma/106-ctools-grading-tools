...
for d in dirs: # now each has the right files in submission attachments
	...
	# trying to check for ps9, this is supposed to be easy
	# files = [f for f in os.listdir("{}/Submission attachment(s)/".format(d))]
	# print files
	# except:
	# 	# TODO make this a better fix -- this doesn't get done
	# 	print "Sorry, you'll need to rename {} pset to ps9.py...".format(dr)
